> ⚠️ **DOCUMENTO ARCHIVADO — SUPERADO POR v1.4.0 (2026-07-24).**
> Esta definición está anclada a la línea de reglas **v2.1.5 (regime engine de 8 regímenes)**,
> que el ciclo de backtesting BT-0..BT-17 **invalidó**: BT-11 reprobó el motor multi-estructura
> (IC/CCS no dan edge honesto). La estrategia vigente es **PCS-only (v1.4.0)**.
> Fuente de verdad actual: `../galecore-estrategia-definicion.md` (conceptual),
> `../galecore-rules-reference.md` (racional por nodo) y `../galecore-research-backtesting.md`
> (validaciones). Se conserva solo como registro histórico del razonamiento previo.
